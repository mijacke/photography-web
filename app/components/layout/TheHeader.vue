...
// Tablet (768-1024px) uses click interaction instead of hover for better touch UX
...
<template>
    <header :class="headerClasses">
        <div class="container-wide">
            <nav
                class="flex items-center justify-between h-20 md:h-24"
                role="navigation"
            ...
            >
                <NuxtLink to="/" class="flex-shrink-0" aria-label="Domovská stránka">
                    <NuxtImg
                        ...
                        height="90"
                        :class="[
                            'h-20 md:h-24 w-auto mt-1 transition-all duration-300',
                            logoClasses,
                        ]"
                        loading="eager"
                    />
                    ...
                    <template v-for="link in navLinks" :key="link.href">
                        ...
                        >
                            ...
                            >
                                ...
                                <img
                                    :src="
                                        isPortfolioDropdownOpen || isLinkActive(link.href)
                                            ? '/svg/icons/chevron-down-warm.svg'
                ...
                <div class="container-wide py-6 flex flex-col gap-4">
                    <template v-for="link in navLinks" :key="link.href">
                        <div v-if="link.hasDropdown">
                            <span
                                class="text-charcoal-700 text-lg font-medium tracking-wide py-2 block"
                            >
                                {{ link.label }}
                            </span>
                            <div class="pl-4 mt-2 space-y-2 border-l-2 border-warm-400">
                                <NuxtLink
                                    ...
                                    :aria-current="
                                        route.path === category.href ? 'page' : undefined
                                    "
