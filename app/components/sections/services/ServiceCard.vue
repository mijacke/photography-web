  ...
  >
    <div class="container-wide">
      ...
      >
        ...
        <div :class="['relative service-image-wrapper', isReversed ? 'lg:order-2' : '']" style="will-change: transform;">
          ...
          <div class="service-frame absolute -bottom-6 -right-6 w-full h-full border-2 border-warm-400 z-0 hidden lg:block"></div>
        </div>
